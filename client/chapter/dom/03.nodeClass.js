...
console.log(first.hidden); // getter (false반환함)
// console.log(first.hidden = true); // setter
// 근데 왜 안없어지냐.. css 파일에서 displa: inline-block 이기 때문! 그래서 지워주면 히든 잘됨
...
// 위 깜빡이는 토글을 좀 더 부드럽게 해보자! Gsap 이용해보기!
