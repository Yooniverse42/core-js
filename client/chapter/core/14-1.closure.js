...
// const result = first();
// result(30) // 2. result를 함수처럼 사용 가능하다.
// 즉, 안쪽에 있는 대상이 바깥 변수를 사용하고, 바깥에서 안쪽 함수에 접근할 수 있는 것을 클로저
...
// const result4 = first();
// const result5 = first();
// 이렇게 사용하면 가비지 컬럭터가 5개 모두 못가져감! 모두 새로운 함수 컨텐스트 환경을 가지고 있음
